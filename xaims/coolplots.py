...
def scattering_potential_qed(
    ...
    """
    Classic potential V(r) = k/r scattering and QED matrix element squared visualizations.
    
    (exact 1-to-1 limit matching between classic and quantum to be done)
    ...
    if potential_k is None:
        att_txt = "attractive and repulsive" # Both
    elif potential_k < 0:
        att_txt = "attractive"
    else:
        att_txt = "repulsive"
...
def plot_mandelstam(m=0.5):
    ...
    # === User parameter: mass m (change as needed) ===
    m = 0.5  # For m=1, 4m^2=4. For other values, the threshold scales accordingly.
