...
**AI in Science tutorial given at AIMS, Cape Town, South Africa (May 2025)**

<br>

September 2026: new version (Bayesian amortization strategies, ground truth comparisons, numerical stability)
...
xaims/posterior.py  - Posterior inference wrappers
xaims/statistics.py - Statistics functions
xaims/unfolding.py  - Binned EM-unfolding
...
If you find this useful in your work, you can cite the repository:
```
@software{aims25,
